...
<body>
    <header class="header-user">
        ...
        <div class="englobe">
            <span id="user-name">
                <span>IsaacMemini</span>
            </span>
            <ul class="fonctionnalite">
                <li><i class="fa-solid fa-plus"></i>ajouter tutoriel</li>
                <li><i class="fa-solid fa-right-from-bracket"></i>déconnexion</li>
            </ul>
        </div>
    </header>
    <main class="container">
        <p class="citation"> <b>les <span>mathématiques</span></b> sont le languages avec lequel Dieu a écrit l'univers.Cette citation de  Galilée,un physicien,mathématicien,astronome et philosophe italien qui a joué un rôle majeur dans la révolution scientifique.</p>
        <section class="tutoriel">
            <div class="cadre">
                <span class="niveau debutant">Débutant</span>
                <header class="header-tutoriel">resolution d'equation</header>
                <p>résoudre une équation consiste à trouver toutes les valeurs possibles de la ou des variables qui rendent l'équation vraie bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb...</p>
            </div>
    ...
    <div class="pagination">
        <div class="elementinactif">«</div>
        <div class="elementinactif">1</div>
        <div class="elementpagination">2</div>
        <div class="elementpagination">3</div>
        <div class="elementpagination">4</div>
        <div class="elementpagination">5</div>
        <div class="elementinactif">...</div>
        <div class="elementpagination">38</div>
        <div class="elementpagination">»</div>
    </div>
