...
<body>
    ...
    <main class="container">
        <p class="citation bloc"> <b>Tous les <span>tutoriels</span></b>envie d'apprendre les maths et comprendre le monde qui vous entourre alors vous etes au bon endroit.</p>
        ...
        <section class="tutoriel">
            <div class="cadre">
                <span class="niveau debutant">Débutant</span>
                <header class="header-tutoriel">resolution d'equation</header>
                <p>résoudre une équation consiste à trouver toutes les valeurs possibles de la ou des variables qui rendent l'équation vraie</p>
            </div>
            <footer class="footer-tutoriel">
                <span class="matiere">
                    <svg  viewBox="0 0 1024 1024"  version="1.1" xmlns="http://www.w3.org/2000/svg"  class="logo-Matiere">
