    ...
    <main class="content">
        ...
        <div class="infos">
            <section class="infoSection">
                ...
                <div class="representation">
                    <i class="logo-video-section fa-brands fa-youtube"></i>40
                </div>
                <a href="#">
            ...
            <section class="infoSection">
                ...
                <div class="representation">
                    <i class="logo-etudiant-section fa-solid fa-graduation-cap"></i>40    
                </div>
                <a href="#">
                    <div class="infoSectionFooter">voir plus...</div>
                </a>
            ...
            <section class="infoSection">
                ...
                <div class="representation">
                    <i class="logo-instructeur-section fa-solid fa-person-chalkboard"></i>40
                </div>
                <a href="#">
                    <div class="infoSectionFooter">voir plus...</div>
                </a>
            ...
            <section class="infoSection">
                ...
                <div class="representation">
                    <i class="logo-personne-section fa-solid fa-users"></i>40
                </div>
                <a href="#">
                    <div class="infoSectionFooter">voir plus...</div>
                </a>
        ...
        <div style="margin-bottom:20px">
            <div class="tableau2">
                ...
                <div class="ligne">
                    <div>resolution d'equation</div>
                    <div>algebre</div>
                    <div>Mohamed Diop</div>
                </div> 
                <div class="ligne">
                    <div>resolution d'equation</div>
                    <div>algebre</div>
