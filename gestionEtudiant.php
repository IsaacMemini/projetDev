    ...
    <main class="content">
        ...
        <div class="cheminTutoriel" style="margin-left:20px;">
            ...
            <div class="ajouterSupprimer">
                ...
                <a href="#" data-tooltip="supprimer" class="tooltip-container"><i class="fa-regular fa-trash-can"></i></a>
            </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Memini Edou</td>
                                <td>Isaac Feglar Fiacre</td>
                                <td>isaacfeglarfiacrememini@esp.sn</td>
                                <td>17-01-2024</td>
                                <td><a href="modifierEtudiant.php"  data-tooltip="modifier" class="tooltip-container"><i class="fa-solid fa-pencil"></i></a></td>
                            </tr>
                            <tr>
                                <td>
                                    <label class="custom-checkbox"> 
